...
public class SaslPrep {
     ...
     * {@code str} for use as a query string.
     * This implements the {@code SASLPrep} algorithm defined in
     * <a href="https://tools.ietf.org/html/rfc4013">RFC 4013</a>.
     * @param str The string to canonicalise.
     * @return The canonicalised string.
     * @throws IllegalArgumentException if the string contained prohibited
     * codepoints, or broke the requirements for bidirectional character
     * handling.
     */
