...
/**
 * Constructs and parses client-first-messages. Message contains a {@link Gs2Header}, a username and
 * a nonce. Formal syntax is:
 *
 * {@code
...
public class ClientFirstMessage implements StringWritable {
   ...
   */
  public ClientFirstMessage(Gs2CbindFlag gs2CbindFlag, String authzid, String cbindName,
  ...
  private static Gs2Header gs2Header(Gs2CbindFlag gs2CbindFlag, String authzid, String cbindName) {
    ...
    if (Gs2CbindFlag.CHANNEL_BINDING_REQUIRED == gs2CbindFlag && null == cbindName) {
      throw new IllegalArgumentException(
          "Channel binding name is required if channel binding is specified");
    }
  ...
  public Gs2Header getGs2Header() {
    ...
    return gs2Header(gs2Header.getChannelBindingFlag(), gs2Header.getAuthzid(),
        gs2Header.getChannelBindingName());
  }
  ...
  /**
   * Limited version of the {@link StringWritableCsv#toString()} method, that doesn't write the GS2
   * header. This method is useful to construct the auth message used as part of the SCRAM
   * algorithm.
   *
