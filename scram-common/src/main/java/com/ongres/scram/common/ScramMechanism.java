 ...
 * hmac function that will not throw a RuntimeException on any JVM, to guarantee true portability of
 * this library.
 */
public interface ScramMechanism {
   ...
   * @throws RuntimeException If the algorithm is not provided by current JVM or any included
   *         implementations
   */
